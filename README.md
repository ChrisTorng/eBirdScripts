...
- 支援多種日期簡寫、常用鳥種簡稱，以及「唱歌」、「聽到」與「一對」等細節。
- 行動裝置預設收合，並可由右上角按鈕展開或收合。
- 盡量填完所有鳥種後一次列出未完成項目，並預設隱藏未觀察到的鳥種以方便核對。
...
4. 確認右側沒有紅字後，按「開始填寫紀錄」。
5. 到鳥種頁後，助手會填入可辨識項目、一次列出問題，並隱藏未觀察鳥種。可按「顯示未觀察到的鳥種項目」恢復完整清單。
6. 人工檢查日期、努力量、鳥種、數量及細節；助手不會送出紀錄。
